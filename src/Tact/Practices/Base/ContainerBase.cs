...
namespace Tact.Practices.Base
{
    public abstract class ContainerBase : IContainer
    {
        ...
        public bool CanResolveGenericType(Stack<Type> stack, Type genericType, Type[] genericArguments, string key = null)
        {
            return TryResolveGenericType(
                out object result,
                stack,
                genericType,
                genericArguments,
        ...
        private bool TryResolveGenericType(out object result, Stack<Type> stack, Type genericType, Type[] genericArguments, string key, bool returnNull)
        {
            if (genericType == null)
            ...
            {
                result = null;
                isSuccessful = CanResolve(stack, type, key);
            }
            else
            {
